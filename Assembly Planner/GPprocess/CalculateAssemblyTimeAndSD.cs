...
namespace GPprocess
{
    public class CalculateAssemblyTimeAndSD
    {
        ...
        public static double GetTimeAndSD(double[] testpoints, string action, out  double meantime1, out double SD)
        {
            ...
            {
                obdataX = readdata.read("../../Evaluation/TrainningTimeData/movingdata/dataset3/TrainX.csv", 5);
                var obdataY = readdata.read("../../Evaluation/TrainningTimeData/movingdata/dataset3/TrainY.csv");
            ...
            {
                var obdataX = readdata.read("../../Evaluation/TrainningTimeData/installdata/dataset3/TrainX.csv", 6);
                var obdataY = readdata.read("../../Evaluation/TrainningTimeData/installdata/dataset3/TrainY.csv");
