...
namespace Assembly_Planner.PostProcessor
{
    internal class WorkerAllocation
    {
        ...
        private static void Allocation(AssemblyCandidate candidate)
        {
            ...
            for (int numberofWorkers = 1; ; numberofWorkers++)
            {
                ...
                for (int counter_i = 0; counter_i < numberofWorkers; counter_i++)
                    worker[counter_i] = new WorkersClass();
